...
export default class DisplayEvent extends React.Component {
    ...
    fetch("/delivery/")
      ...
      .then((data) => {
        ...
        const filteredData = data.filter((element) => {
          return (
            element.deliveryType.toLowerCase().includes(query.toLowerCase()) >=
              0 ||
  ...
  deleteData = async (id, type) => {
    ...
    if (window.confirm("Do you want to delete !")) {
      await axios.delete(`/delivery/delete/${id}`);
                    ...
                    >
                      <div className="details">
                        <div>
                          ...
                          <p>
                            <b style={{ color: "blue" }}>Delivery Type : </b>
                            {i.deliveryType}
                          </p>
                          <p>
                            <b style={{ color: "orange" }}>Delivery Date : </b>
                            {i.date}
                          </p>
                          <p>
