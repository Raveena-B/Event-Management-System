    ...
    <div>
      <div id="header">
        <section className="bg3">
          ...
          <center>
            <h1 style={{ color: "white" }}>Add New Delivery Items ..</h1>
          </center>
          <form
          ...
          >
            <div className="cmb-3">
              <label for="deliveryType" className="food">
                Delivery Type
              </label>
              <br />
              <br />
              <input
                type="text"
                placeholder="Enter the deliveryType"
          ...
          <a href="/displaydelivery">
            <button className="display">Display Delivery Items</button>
          </a>
        </section>
      </div>
