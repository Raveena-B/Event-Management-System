    ...
    fetch("/event/")
      ...
      .then((data) => {
        ...
        const filteredData = data.filter((element) => {
          return (
            element.eventId.toLowerCase().includes(query.toLowerCase()) >= 0 ||
            element.eventName.toLowerCase().includes(query.toLowerCase()) >=
              0 ||
                    ...
                    >
                      <div className="details">
                        <div>
                          ...
                          <p>
                            <b style={{ color: "blue" }}>Event Id : </b>
                            {i.eventId}
                          </p>
                          <p>
                            <b style={{ color: "orange" }}>Event Name : </b>
                            {i.eventName}
                          </p>
                          <p>
