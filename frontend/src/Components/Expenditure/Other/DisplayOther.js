...
export default class DisplayOther extends React.Component {
  state = {
    query: "",
    data: [],
    filteredData: [],
    ...
    fetch("/other/")
      ...
      .then((data) => {
        ...
        const filteredData = data.filter((element) => {
          return (
            element.forWhat.toLowerCase().includes(query.toLowerCase()) >= 0 ||
  ...
  deleteData = async (id, type) => {
    ...
    if (window.confirm("Do you want to delete !")) {
      await axios.delete(`/other/delete/${id}`);
                    ...
                    >
                      <div className="details">
                        <div>
                          ...
                          <p>
                            <b style={{ color: "blue" }}>For What : </b>
                            {i.forWhat}
                          </p>
                          <p>
                            <b style={{ color: "orange" }}> Date : </b>
                            {i.date}
                          </p>
                          <p>
